...
class Feedback:
    ...
    def __init__(self, master):
        ...
        master.title('Explore California Feedback')   # Window title
        master.resizable(False, False)                # Users can not resize
        master.configure(background = '#e1d8b9')      # Add color to background
