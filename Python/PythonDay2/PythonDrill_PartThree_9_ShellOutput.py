...
[(1, u'Homer Simpson', u'Male', 40, u'Nuclear Plant')]
>>> 
================ RESTART: C:/Python27/pythonDay2Databases8.py ================
Number of changes:  1
[(1, u'Homer Simpson', u'Male', 41, u'Nuclear Plant')]
>>> 
================ RESTART: C:/Python27/pythonDay2Databases9.py ================
Number of changes:  0

Traceback (most recent call last):
  File "C:/Python27/pythonDay2Databases9.py", line 21, in <module>
    cursor = conn.execute("SELECT * from SIMPSON_INFO")
OperationalError: no such table: SIMPSON_INFO
>>> 
